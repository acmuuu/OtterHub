...
export function FileCardListBase({
  file,
  actions,
  icon,
  rowClassName,
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={cn(
            "flex items-center justify-center shrink-0 opacity-70 group-hover:opacity-100 transition-opacity",
            iconClassName,
          )}
        >
          {icon}
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-0.5">
          <p
            className={cn(
              "text-sm font-medium truncate leading-tight transition-all duration-300",
