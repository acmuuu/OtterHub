  ...
  return (
    ...
    >
      <ReactPaginate
        ...
        pageLinkClassName="min-w-[36px] h-9 flex cursor-pointer items-center justify-center rounded-md text-sm text-foreground/80 hover:bg-secondary/50 transition-colors"
        previousClassName="flex items-center justify-center"
        previousLinkClassName="min-w-[36px] h-9 flex cursor-pointer items-center justify-center rounded-md text-sm text-foreground/80 hover:bg-secondary/50 transition-colors px-3"
        nextClassName="flex items-center justify-center"
        nextLinkClassName="min-w-[36px] h-9 flex cursor-pointer items-center justify-center rounded-md text-sm text-foreground/80 hover:bg-secondary/50 transition-colors px-3"
